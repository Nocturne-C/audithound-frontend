...
export type WorkflowCatalogItem = Pick<
  WorkflowDefinition,
  "id" | "name" | "description" | "version" | "builtIn" | "executable" | "tags" | "updatedAt"
> & {
  nodeCount: number;
...
export const DEFAULT_WORKFLOW = defaultWorkflow as WorkflowDefinition;
export const FOCUSED_WORKFLOW = focusedWorkflow as WorkflowDefinition;
